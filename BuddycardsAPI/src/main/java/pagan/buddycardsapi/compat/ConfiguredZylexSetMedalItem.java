...
public class ConfiguredZylexSetMedalItem extends ZylexSetMedalItem {
    private final ConfiguredMedalType configuredType;

    public ConfiguredZylexSetMedalItem(ConfiguredMedalType configuredType, BuddycardSet set, Item.Properties properties) {
